...
export default function QuickClick({ children, shortTitle }) {
   return (
      <div className='flex border border-gray-400/50 items-center text-brand-button rounded-full lg:px-[2.5em] lg:py-[2.5em] px-4 py-2.5 hover:border-brand-button hover:cursor-pointer group'>
